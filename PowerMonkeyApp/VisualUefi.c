...
/*******************************************************************************
 * Below code is only for compilations with VisualUEFI
 * EDK2 builds shall have this code path disabled
 ******************************************************************************/

#if defined(_VISUALUEFI)

extern CONST UINT32 _gUefiDriverRevision = 0;
CHAR8* gEfiCallerBaseName = "PowerMonkey";
